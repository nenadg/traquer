...
Controls.prototype.recording=function(a,b){var c=a.traquer,d=b.target;c.isRecording?(d.className="playstop",c.stop(),c.play(c.recordedEvents)):(c.start(),d.className="playstop squared")};"use strict";var EventBase=function(a){if(!(this instanceof EventBase))return new EventBase;if(!(a&&a instanceof Traquer))throw Error("Can't instantiate EventBase without Traquer instance!");this.traquer=a};
...
a.type,d=a.raw;if(d.code&&-1<d.code.indexOf("Key"))c=new KeyboardEvent(c);else{c=new KeyboardEvent(c,{bubbles:!0,view:null});c.__fake={};for(var e in d)if("isTrusted"!==e&&d.hasOwnProperty(e)){var f=d[e],g=function(a){return this.__fake["sub"+a]}.bind(c,e);Object.defineProperty(c,e,{get:g});c.__fake["sub"+e]=f}}b.dispatchEvent(c)},UIEvents:function(a,b){var c=new UIEvent(a.raw);b.dispatchEvent(c)},selectionEvents:function(a,b){var c=focusEvents(a,b);b.dispatchEvent(c)},empty:function(a,b){var c=document.createEvent("HTMLEvents");
c.initEvent(a.raw,!0,!0);b.dispatchEvent(c)}};"use strict";var Traquer=function(){if(!(this instanceof Traquer))return new Traquer;this.index=0;this.logging=!1;this.recordedEvents=[];this.previousElement=null;this.eventNames="mousemove mouseenter mouseleave mouseover mousedown mouseup mouseout click scroll contextmenu wheel focus focusin focusout DOMFocusIn input textinput keypress keydown keyup change DOMFocusOut selectstart selectionchange select DOMActivate".split(" ")};
